...
This automation framework is built to reflect real QA industry practices, including specification-based requests, response validation, reusable architecture, chaining, and schema checks.
It serves as a strong portfolio project for automation and manual QA interviews.
